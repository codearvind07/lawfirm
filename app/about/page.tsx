      ...
      <section className="relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-800 via-slate-900 to-slate-950 pt-32 pb-20 lg:pt-40 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 flex flex-col lg:flex-row gap-16 items-center">
          <div className="max-w-2xl lg:w-1/2">
            ...
            <h1 className="font-['Palatino_Linotype','Book_Antiqua',Georgia,serif] text-4xl leading-tight text-white sm:text-5xl lg:text-5xl xl:text-6xl mb-6">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="grid sm:grid-cols-2 gap-6 lg:mt-0 mt-8">
              {pillars.map((pillar) => (
                <article key={pillar.title} className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:shadow-md hover:border-amber-300/50">
      ...
      <section className="bg-slate-950 py-24 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            {stats.map((item) => (
              <article key={item.value} className="flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-sm transition hover:bg-white/10">
